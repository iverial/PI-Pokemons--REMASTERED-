      ...
      <div>
        ...
        <div className={styles.container_about}>
          ...
          <div className={styles.conteiner_principal}>
            ...
            <div>
              <p className={styles.text_cita}>
                Algunos entrenadores no tienen miedo. Para ellos, este es solo
                un desafío más. Siguen sus corazones. Eso es lo que los
                distingue y los convertirá en Maestros Pokémon. Buena suerte a
                todos ustedes.
                <br />
                <br />
                -Miranda.
          ...
          <div className={styles.conteiner}>
            <p className={styles.text}>
              ...
              Application (SPA). Los datos se extraen de la API de{" "}
              <a href="https://pokeapi.co/" target="blanc" alt="pokeapi">
                https://pokeapi.co/
              </a>
          ...
          <div className={styles.conteiner_tecnologias}>
            <img
              className={styles.image_tecnologias}
              src={logo_react}
              alt="react"
            />
            <img
